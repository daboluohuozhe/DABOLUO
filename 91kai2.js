...
[Script]
瑟瑟视频 = type=http-request,pattern=^https:\/\/[^#]*\.(mp4|mov|avi|mkv|flv|wmv|webm|m4v|3gp|mpeg|mpg|m3u8)[^#]*,requires-body=0,script-path=https://raw.githubusercontent.com/daboluohuozhe/DABOLUO/main/TONGSHA2.js,script-update-interval=0
